...
msg7 = research.messages.create!(
  text: 'Pricing sensitivity analysis: 65% of prospects found our enterprise tier ' \
        'reasonably priced but wanted annual billing options.',
...
msg9 = culture.messages.create!(
  text: 'How do we maintain team cohesion with our fully remote setup? ' \
        "I've noticed communication gaps between timezones.",
...
Rails.logger.debug do
  "Seeded #{Conversation.count} conversations, #{Message.count} messages, #{Thought.count} thoughts."
end
Rails.logger.debug ''
Rails.logger.debug 'Search demos you can try:'
Rails.logger.debug "  Conversations: 'strategy', 'sprint', 'enterprise', 'remote'"
Rails.logger.debug "  Messages: 'mobile', 'compliance', 'pricing', 'webhook', 'timezone'"
